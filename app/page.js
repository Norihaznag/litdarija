  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Learn new skills in Moroccan Darija</h1>
              <p className="text-lg md:text-xl mb-6">High-quality courses in finance, web development, construction, and more - all in your language!</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-8 text-center">Browse Courses by Category</h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((category, index) => (
              <div key={index} className="bg-gray-50 hover:bg-gray-100 rounded-lg p-6 transition duration-200 cursor-pointer border border-gray-200 hover:border-emerald-200 hover:shadow-md">
                <div className="text-4xl mb-3">{category.icon}</div>
                <h3 className="text-xl font-semibold mb-2 text-gray-800">{category.name}</h3>
                <p className="text-gray-600 mb-3">{category.description}</p>
                <div className="text-emerald-600 font-semibold">{category.courseCount} courses</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            ...
            <a href="#" className="text-emerald-600 hover:text-emerald-700 font-semibold flex items-center">
              View all courses
              ...
              <div key={index} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition duration-200">
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <span className="bg-emerald-100 text-emerald-800 text-sm px-3 py-1 rounded-full">{course.level}</span>
